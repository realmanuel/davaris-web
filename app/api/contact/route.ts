...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { error: notifyError } = await resend.emails.send({
      from:    'Davaris Contact <no-reply@davarisio.com>', // replace with your verified domain e.g. no-reply@davaris.com
      to:      ['davarisioagency@gmail.com'],                     // replace with real receiving email
      replyTo: email,
